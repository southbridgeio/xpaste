...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Xpaste web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 15Eflxs4IH60DX3Dy84dHqhSQEsFBmuj3_JP0Sshbyw
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("xpaste.log", "w"))
  #
  #
end
