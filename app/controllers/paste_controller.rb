class PasteController < ApplicationController
  ...
  skip_before_action :verify_authenticity_token, only: [ :create, :create_from_file ]
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.text { render plain: @paste.body }
  ...
  def create_from_file
    ...
    request_body.set_encoding("utf-8")
    request_body = request_body.is_a?(File) ? request_body.read : request_body.string
  ...
  def paste_params
    params.permit(:body, :language, :auto_destroy, :ttl_days)
  end
